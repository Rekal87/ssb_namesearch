      ...
      <div>
        <div className="ssb-footer-wrapper">
          <div className="container">
            ...
            <div className="footer-content container">Text</div>
            <div className="bottom-row flex-row justify-space-between flex-wrap container-lg">
              <div className="global-links">
                <a
                  href="https://www.ssb.no/"
                  className="ssb-link negative link-text"
                  isExternal
                >
                  Statistisk sentralbyrå © 2019
                </a>
                <a
                  href="https://www.ssb.no/a-aa"
                  className="ssb-link negative link-text"
                  isExternal
                >
                  A-Å
                ...
                <a
                  href="https://www.ssb.no/nettstedskart"
                  className="ssb-link negative link-text"
                  isExternal
                >
                  Nettstedskart
              ...
              <div className="social-links">
                <a
                  className="ssb-link negative with-icon"
                ...
                <a
                  className="ssb-link negative with-icon"
                  href="https://twitter.com/ssbnytt"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <a
                  class="ssb-link negative with-icon"
                  href="https://www.ssb.no/informasjon/rss"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div class="icon-wrapper">
